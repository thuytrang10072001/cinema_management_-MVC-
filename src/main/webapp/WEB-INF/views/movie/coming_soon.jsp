...
<body>
    ...
    <div class="main-container">
        ...
        <div class="link-container">
            <h2 class="movie-title">Phim Sắp Chiếu</h2>
            <a class="link" href="http://localhost:8080/QuanLyRapChieuPhim/film/showing.htm">Phim Đang Chiếu</a>
        ...
        <div class="container-movie">
            ...
            <div class="list-movie-item">
                ...
                <div class="btn-wrap">
                    ...
                    <a href="https://www.youtube.com/watch?v=ZR99nOkEolM&t=3s"><button class="btn-buy-ticket">Trailer</button></a>
                </div>  
            </div>
        </c:forEach>
        </div>
